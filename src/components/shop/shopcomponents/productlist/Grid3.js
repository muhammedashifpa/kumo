            ...
            <div className="row align-items-center">
                    ...
                    <div className="product_grid card b-0">
                        ...
                        <div className="card-body p-0">
                            <div className="shop_thumb position-relative">
                                <a className="card-img-top d-block overflow-hidden ovr-hide" href="shop-single-v1.html"><img className="card-img-top" src="assets/img/product/7.jpg" alt="..."/></a>
                                <a className="card-img-top d-block overflow-hidden ovr-show" href="shop-single-v1.html"><img className="card-img-top" src="assets/img/product/7-a.jpg" alt="..."/></a>
                                <div className="product-hover-overlay btn d-flex align-items-center justify-content-center">
                                    <div className="group_btn">
                                        <a href="#" className="prd_btn_square"><i className="ti-fullscreen"></i></a>
                                        <a href="#" className="prd_btn_square"><i className="lni lni-heart"></i></a>
                                        <a href="#" className="prd_btn_square"><i className="lni lni-shopping-basket"></i></a>
                                        <a href="#" className="prd_btn_square"><i className="lni lni-shuffle"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div className="product_grid card b-0">
                        ...
                        <div className="card-body p-0">
                            <div className="shop_thumb position-relative">
                                <a className="card-img-top d-block overflow-hidden ovr-hide" href="shop-single-v1.html"><img className="card-img-top" src="assets/img/product/8.jpg" alt="..."/></a>
                                <a className="card-img-top d-block overflow-hidden ovr-show" href="shop-single-v1.html"><img className="card-img-top" src="assets/img/product/8-a.jpg" alt="..."/></a>
                                <div className="product-hover-overlay btn d-flex align-items-center justify-content-center">
                                    <div className="group_btn">
                                        <a href="#" className="prd_btn_square"><i className="ti-fullscreen"></i></a>
                                        <a href="#" className="prd_btn_square"><i className="lni lni-heart"></i></a>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div className="product_grid card b-0">
                        ...
                        <div className="card-body p-0">
                            <div className="shop_thumb position-relative">
                                <a className="card-img-top d-block overflow-hidden ovr-hide" href="shop-single-v1.html"><img className="card-img-top" src="assets/img/product/9.jpg" alt="..."/></a>
                                <a className="card-img-top d-block overflow-hidden ovr-show" href="shop-single-v1.html"><img className="card-img-top" src="assets/img/product/9-a.jpg" alt="..."/></a>
                                <div className="product-hover-overlay btn d-flex align-items-center justify-content-center">
                                    <div className="group_btn">
                                        <a href="#" className="prd_btn_square"><i className="ti-fullscreen"></i></a>
                                        <a href="#" className="prd_btn_square"><i className="lni lni-heart"></i></a>
                        ...
                        <div className="card-footer b-0 p-3 pb-0 bg-white d-flex align-items-start justify-content-center">
                            <div className="text-left">
                                <div className="text-center">
                                    <h5 className="fw-bolder fs-md mb-0 lh-1 mb-1"><a href="shop-single-v1.html">Half Running Suit</a></h5>
                                    <div className="elis_rty"><span className="ft-bold fs-md text-dark">$80.00</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div className="product_grid card b-0">
                        ...
                        <div className="card-body p-0">
                            <div className="shop_thumb position-relative">
                                <a className="card-img-top d-block overflow-hidden ovr-hide" href="shop-single-v1.html"><img className="card-img-top" src="assets/img/product/10.jpg" alt="..."/></a>
                                <a className="card-img-top d-block overflow-hidden ovr-show" href="shop-single-v1.html"><img className="card-img-top" src="assets/img/product/10-a.jpg" alt="..."/></a>
                                <div className="product-hover-overlay btn d-flex align-items-center justify-content-center">
                                    <div className="group_btn">
                                        <a href="#" className="prd_btn_square"><i className="ti-fullscreen"></i></a>
                                        <a href="#" className="prd_btn_square"><i className="lni lni-heart"></i></a>
