...
function ProductViewModal() {
	const initialValue = Object.freeze({Vsize: 32,Vcount: 1,});
	...
	const product = useSelector((state)=>state.pvmr.product)
									...
									<div className="quick_view_slide">
										...
										<div className="single_view_slide"><img src="assets/img/product/4.jpg" className="img-fluid" alt="" /></div> */}
										{
											product.images.map((image)=>{
												return(
													<div className="single_view_slide"><img src={image.image} className="img-fluid" alt="" /></div> 
												)
											})
										}
									</div>
								...
								<div className="quick_view_capt">
									<div className="prd_details">
										...
										<div className="prt_02 mb-2">
											<h2 className="ft-bold mb-1">{product.product_name}</h2>
											<div className="text-left">
												...
												<div className="elis_rty"><span className="ft-medium text-muted line-through fs-md mr-2">₹{product.price}</span><span className="ft-bold theme-cl fs-lg mr-2">₹{product.offer_price}</span><span className="ft-regular text-danger bg-light-danger py-1 px-2 fs-sm">Out of Stock</span></div>
											</div>
										</div>
										...
										<div className="prt_04 mb-4">
											...
											<div className="text-left pb-0 pt-2">
												<div className="form-check size-option form-option form-check-inline mb-2">
													<input className="form-check-input" onChange={handleChange} type="radio" value="28" name="Vsize" id="V28"/>
												...
												<div className="form-check form-option size-option  form-check-inline mb-2">
													<input className="form-check-input" onChange={handleChange} type="radio" value="30" name="Vsize" id="V30"/>
													<label className="form-option-label" htmlFor="V30">30</label>
												</div>
												<div className="form-check form-option size-option  form-check-inline mb-2">
													<input className="form-check-input" onChange={handleChange} type="radio" value="32" name="Vsize" id="V32"/>
													<label className="form-option-label" htmlFor="V32">32</label>
												</div>
												<div className="form-check form-option size-option  form-check-inline mb-2">
													<input className="form-check-input" onChange={handleChange} type="radio" value="34" name="Vsize" id="V34"/>
													<label className="form-option-label" htmlFor="V34">34</label>
												</div>
												<div className="form-check form-option size-option  form-check-inline mb-2">
													<input className="form-check-input" onChange={handleChange} type="radio" value="36" name="Vsize" id="V36"/>
													<label className="form-option-label" htmlFor="V36">36</label>
												</div>
												<div className="form-check form-option size-option  form-check-inline mb-2">
													<input className="form-check-input" onChange={handleChange} type="radio" value="38" name="Vsize" id="V38"/>
													<label className="form-option-label" htmlFor="V38">38</label>
												</div>
												<div className="form-check form-option size-option  form-check-inline mb-2">
													<input className="form-check-input" onChange={handleChange} type="radio" value="40" name="Vsize" id="V40"/>
										...
										<div className="prt_05 mb-4">
											<div className="form-row mb-7">
												<div className="col-12 col-lg-auto">
													{/* <!-- Quantity --> */}
													<select onChange={handleChange} defaultValue='1' name="Vcount" className="mb-2 custom-select" >
												...
												<div className="col-12 col-lg">
													{/* <!-- Submit --> */}
													<button type="submit"  onClick={() => dispatch(addCart(product.id,user.user_id,value.Vsize,value.Vcount)) } className="btn btn-block custom-height bg-dark mb-2">
														<i className="lni lni-shopping-basket mr-2"></i>Add to Cart 
													</button>
												</div>
												<div className="col-12 col-lg-auto">
													{/* <!-- Wishlist --> */}
													<button onClick={() => dispatch(addFav(product.id,user.user_id))} className="btn custom-height btn-default btn-block mb-2 text-dark" data-toggle="button">
